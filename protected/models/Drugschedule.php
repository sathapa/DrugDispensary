...
class Drugschedule extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pid, DrugName, DosePerDay, TotalDay, RecentDay', 'required'),
            ...
            array('pid+DrugName+RecentDay', 'application.extensions.uniqueMultiColumnValidator' , 'message'=>'Error vayo hai'),
        );
	}
