...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top">
       ...
       <?php $this->widget(
            ...
            array( 'label' => 'Patient Registration', 'url' => array('/patient/create'), 'itemOptions' => array('class' => 'nav-header')),
            array('label' => 'Drug Prescription', 'url' => array('/drug/admin'), 'itemOptions'=> array('class' => 'nav-header')),
            array('label' => 'Drug Schedule', 'url' => array('/drug/listPatient'), 'itemOptions'=> array('class' => 'nav-header')),
