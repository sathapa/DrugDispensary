...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand"><strong>DRUG DISPENSARY</strong></a>
            <div class="nav-collapse">
                <?php $this->widget('zii.widgets.CMenu',array(
                    'htmlOptions' => array( 'class' => 'nav' ),
                    'activeCssClass'	=> 'active',
                    'items'=>array(
                        array('label'=>'Patient Registration', 'url'=>array('/patient/create')),
                        array('label'=>'Drug Prescription', 'url'=>array('/drug/create')),
						array('label' => 'Drug Schedule', 'url' => array('/drug/listPatient')),
...
//        'type' => 'pills',
//        'items' => array(
//            array('label' => 'Tasks', 'itemOptions' => array('class' => 'nav-header')),
//            array( 'label' => 'Patient Registration', 'url' => array('/patient/index'), 'itemOptions' => array('class' => 'nav-header')),
//            array('label' => 'Drug Prescription', 'url' => array('/drug/index'), 'itemOptions'=> array('class' => 'nav-header')),
//            array('label' => 'User', 'url'=> array('/user/index'), 'itemOptions' => array('class' => 'nav-header')),
//
//        )
//    )
//); ?>
	  ...
	  <div class="container">
		<div class="row">
			...
			<div id="footer-terms" class="col-md-6">
				© Developed By:<a href="http://www.mdevsolutions.com" target="_blank">MHC</a>.
			</div> <!-- /.span6 -->
		 </div> <!-- /row -->
	  </div> <!-- /container -->
	</div>
